...
For example, $\hat{x}$ denotes a vector, while $m$ 
represents a scalar. By default, a vector $\hat{x}$ 
...
\noindent Given the cart and the pendulum specifications and their initial 
...
Calculate the state of the system, position of the cart and the angle of the pendulum arm, over time.
